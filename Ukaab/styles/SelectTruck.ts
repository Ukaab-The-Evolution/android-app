...
export const TrucksGrid = styled.View`
    gap: 28px;
    margin-bottom: 28px;
`

export const TruckRow = styled.View`
    flex-direction: row;
...
export const TruckInfo = styled.View`
    align-items: center;
    gap: 2px;
`
...
export const TruckPlate = styled.Text`
    color: #5F5F5F;
    font-size: 12px;
...
export const TruckCapacity = styled.Text`
    color: #5F5F5F;
    font-size: 12px;
    font-family: Poppins-Medium;
    font-weight: 500;
