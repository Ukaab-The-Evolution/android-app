...
export const RememberMeCheckBoxButton = styled(TouchableNativeFeedback).attrs({
    useForeground: true
})`

`

export const RememberMeCheckBox = styled.View<{active?: boolean}>`
    height: 16px;
    width: 16px;
    display: flex;
    align-items: center;
    ...
    background: ${({active}) => active ? "#3B6255" : "transparent"};
    overflow: hidden;
`
